...
main =
    ...
    putStrLn (show result ++ " errors in: " ++ show (result2Errors result))
...
result2Errors ABitDifferent = FP_Rounding
result2Errors Infinity = FP_Overflow
result2Errors Zero = FP_Underflow
result2Errors VeryDifferent = Int_Overflow
